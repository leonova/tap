...
if(isset($_POST))
{
    ...
    $DestinationDirectory   = 'uploads/'.$_POST['user-id'].'/'; //specify upload directory ends with / (slash)
    ...
    if(resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType))
    {
        ...
        */
		session_start();
		$_SESSION['thumbimage']=$ThumbPrefix.$NewImageName;
		$_SESSION['largeimage']=$NewImageName;
		$_SESSION['childid']=$_POST['child-id'];

		header('Location: profile-page-setting.php');
       /*
